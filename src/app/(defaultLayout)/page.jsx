...
export default function Home() {
  return (
    <>
      ...
      <Hero
        title="'ดวงตาคือจุดเริ่มต้นของความงามที่แท้จริง' ที่ D Bangkok Clinic เราเชี่ยวชาญในการดูแลและแก้ไขปัญหาดวงตาทุกประเภท"
        subTitle="ทีมแพทย์เฉพาะทางของเราพร้อมให้บริการด้วยความเชี่ยวชาญและความใส่ใจทุกรายละเอียด ตั้งแต่การทำตาสองชั้น การปรับกล้ามเนื้อตา ไปจนถึงการแก้ไขปัญหาผิวรอบดวงตา เพื่อให้คุณมั่นใจและพร้อมเผยความงามในทุกมุมมอง

เราเข้าใจว่าทุกเคสมีความแตกต่าง เราจึงมุ่งเน้นการออกแบบการรักษาที่เฉพาะเจาะจงสำหรับคุณโดยเฉพาะ ด้วยการดูแลที่ใกล้ชิดจากแพทย์ผู้เชี่ยวชาญ เราพร้อมหาทางออกที่ดีที่สุดร่วมกัน เพื่อผลลัพธ์ที่ดูเป็นธรรมชาติและตรงใจ

ปรึกษาฟรี! ไม่มีค่าใช้จ่าย มั่นใจได้ว่าเราพร้อมอยู่เคียงข้างคุณในทุกขั้นตอนของความงาม"
