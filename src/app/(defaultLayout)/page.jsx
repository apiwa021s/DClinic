  ...
  return (
    <>
      ...
      <Section topMd={170} topLg={120} topXl={80}>
        <GallerySection
          sectionTitle="เรามีบริการเสริมความงามที่ครอบคลุม ไม่ว่าจะเป็นการทำตาสองชั้น การใช้เลเซอร์ในการยกกระชับผิว ฟิลเลอร์ โบท็อกซ์ และการฉีดไขมันเพื่อลดเหนียง เรามั่นใจว่าทุกบริการของเราจะช่วยเสริมความงามและเพิ่มความมั่นใจให้กับคุณ."
          sectionTitleUp="ผลงานของเรา"
          data={galleryData}
        />
      </Section>
    </>
